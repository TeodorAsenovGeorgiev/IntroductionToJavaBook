...
public class Problem8_12_arabicToRoman {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.println("Въведете число от 1 до 3999: ");
        int arabicNum = input.nextInt();
        String result = "";

        int thousands = arabicNum/1000, hundreds = (arabicNum/100)%10, tens = (arabicNum/10)%10, ones = arabicNum%10;
        ...
        System.out.println("Римското число отговарящо на " +arabicNum+" e " + "\""+result+"\"");
    }
}
